    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <p>📊 Full admin dashboard with vendor management coming in Phase 9</p>
                <p>🎯 Features to be added:</p>
                <ul style="text-align: left; margin-left: 2rem; color: #7a5f57;">
                    <li>Approve/Reject vendor registrations</li>
                    <li>View all shops and products</li>
                    <li>Monitor orders and payments</li>
